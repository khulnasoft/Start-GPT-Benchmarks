...
from startbenchmarks.utils.challenge import Challenge
from startbenchmarks.utils.data_types import ChallengeData, SuiteConfig
from startbenchmarks.utils.utils import get_test_path
...
def generate_tests() -> None:  # sourcery skip: invert-any-all
    ...
    json_files = deque(
        glob.glob(
            f"{startbenchmarks.start_benchmark.CHALLENGES_PATH}/**/data.json",
            recursive=True,
        )
    )
    regression_tests = startbenchmarks.start_benchmark.get_regression_data()
