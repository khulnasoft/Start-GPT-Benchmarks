...
from startbenchmarks.reports.ReportManager import ReportManager
...
def run_benchmark(
    ...
    if os.path.join("Start-GPT-Benchmarks") in str(HOME_DIRECTORY) and not AGENT_NAME:
        print(
            "If you are running from the Start-GPT-Benchmarks repo, you must have AGENT_NAME defined."
        )
        return 1
