...
from startbenchmarks.agent_api_interface import run_api_agent
from startbenchmarks.utils.data_types import ChallengeData, Ground
from startbenchmarks.utils.prompts import (
    END_PROMPT,
    FEW_SHOT_EXAMPLES,
    PROMPT_MAP,
    SCORING_MAP,
)
from startbenchmarks.utils.utils import agent_eligibible_for_optional_categories
...
class Challenge(ABC):
    ...
    async def setup_challenge(self, config: Dict[str, Any], cutoff: int) -> None:
        from startbenchmarks.agent_interface import copy_artifacts_into_workspace, run_agent
    ...
    def skip_optional_categories(self, config: Dict[str, Any]) -> None:
        ...
        categories = [
            category
            for category in startbenchmarks.start_benchmark.OPTIONAL_CATEGORIES
